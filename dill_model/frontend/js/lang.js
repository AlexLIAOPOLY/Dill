...
const LANGS = {
    'zh-CN': {
        ...
        exposure_dist: '曝光剂量分布 (2D) (Y, Z平面)',
        thickness_dist: '光刻胶厚度分布 (2D) (Y, Z平面)',
    ...
    en: {
        ...
        exposure_dist: 'Exposure Dose Distribution (2D) (Y, Z Plane)',
        thickness_dist: 'Photoresist Thickness Distribution (2D) (Y, Z Plane)',
        exposure_xy_dist: 'Exposure Dose Distribution (2D) (X, Y Plane)',
        thickness_xy_dist: 'Photoresist Thickness Distribution (2D) (X, Y Plane)',
