...
const LANGS = {
    zh: {
        ...
        sine_wave_type_multi: '多维正弦波',
        kx_label: 'Kx (空间频率x)',
        kx_description: 'x方向空间频率，单位：rad/μm',
        ky_label: 'Ky (空间频率y)',
        ky_description: 'y方向空间频率，单位：rad/μm（0表示仅x方向）',
        phi_label: 'φ(t) (相位表达式)',
    ...
    en: {
        ...
        sine_wave_type_multi: 'Multi-dimensional Sine Wave',
        kx_label: 'Kx (Spatial Frequency x)',
        kx_description: 'Spatial frequency in x-direction, unit: rad/μm',
        ky_label: 'Ky (Spatial Frequency y)',
        ky_description: 'Spatial frequency in y-direction, unit: rad/μm (0 means x-direction only)',
